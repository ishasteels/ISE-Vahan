...
var API = 'https://script.google.com/macros/s/AKfycbx5KLiR7lE2nuT2oW8egZhSHRTuEuPs7YGbn6RWnv4jJZOYsoWhC5IX6-a5-UcnGhJl/exec'; // ← Paste GAS URL after deploy
...
function showAddTripForm() {
  ...
  showModal('Log Trip', `
    <div class="form-grid">
      ...
      <div class="form-group"><label>Material Type</label><input id="f_MaterialType" placeholder="TMT Bars"></div>
